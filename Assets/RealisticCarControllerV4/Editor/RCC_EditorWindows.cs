...
public class RCC_EditorWindows : Editor {
    ...
    private static RCC_CarControllerV4 SelectedCar() {
    ...
    static void CreateAIBehavior() {
        ...
        if (!Selection.activeGameObject.GetComponentInParent<RCC_CarControllerV4>(true)) {
            ...
            EditorUtility.DisplayDialog("Realistic Car Controller | Your Vehicle Has Not RCC_CarControllerV3", "Your Vehicle Has Not RCC_CarControllerV3.", "Close");
            return;
