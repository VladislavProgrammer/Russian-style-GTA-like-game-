...
public class RCC_WheelCollider : RCC_Core {
    ...
    public AudioClip DeflateAudio {
        ...
        get {
            ...
            return Settings.wheelDeflateClip;
    ...
    public AudioClip InflateAudio {
        ...
        get {
            ...
            return Settings.wheelInflateClip;
    ...
    private void CreateAudio() {
        ...
        audioSource = NewAudioSource(Settings.audioMixer, CarController.gameObject, "Skid Sound AudioSource", 5f, 50f, 0f, audioClip, true, true, false);
    ...
    private void Frictions() {
        ...
        // Also damp too.
        WheelCollider.wheelDampingRate = GroundMaterials.frictions[groundIndex].damp;
    ...
    private void Drift() {
        ...
        if (CarController.wheelTypeChoise == RCC_CarControllerV4.WheelType.RWD) {
    ...
    private void Audio() {
        ...
        if ((bumpForce) >= 5000f) {
            ...
            AudioSource bumpSound = NewAudioSource(Settings.audioMixer, CarController.gameObject, "Bump Sound AudioSource", 5f, 50f, (bumpForce - 5000f) / 3000f, Settings.bumpClip, false, true, true);
    ...
    public bool IsSkidding() {
        ...
        for (int i = 0; i < CarController.AllWheelColliders.Length; i++) {
            ...
            if (CarController.AllWheelColliders[i].totalSlip > GroundMaterials.frictions[groundIndex].slip)
                return true;
        ...
        for (int i = 0; i < GroundMaterials.terrainFrictions.Length; i++) {
            ...
            if (wheelHit.collider.sharedMaterial == GroundMaterials.terrainFrictions[i].groundMaterial) {
                ...
                if (currentTerrain != null) {
                    ...
                    groundIndex = GroundMaterials.terrainFrictions[i].splatmapIndexes[groundIndex].index;
                    return;
