...
public class RCC_CarSelectionExample : RCC_Core {
    ...
    private List<RCC_CarControllerV4> _spawnedVehicles = new List<RCC_CarControllerV4>();       // Our spawned vehicle list. No need to instantiate same vehicles over and over again. 
