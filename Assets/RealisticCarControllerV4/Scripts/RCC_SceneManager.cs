...
public class RCC_SceneManager : RCC_Singleton<RCC_SceneManager> {
    ...
    public RCC_CarControllerV4 activePlayerVehicle;     //  Current active player vehicle.
    public RCC_Camera activePlayerCamera;       //  Current active player camera as RCC Camera.
    public RCC_UI_DashboardDisplay activePlayerCanvas;       //  Current active UI canvas.
    public Camera activeMainCamera;     //  Current active main camera.
    private RCC_CarControllerV4 lastActivePlayerVehicle;        //  Last selected player vehicle.
    ...
    public List<RCC_CarControllerV4> allVehicles = new List<RCC_CarControllerV4>();     //  All vehicles.
    ...
    /// <param name="vehicle"></param>
    /// <returns></returns>
    private IEnumerator Freeze(RCC_CarControllerV4 vehicle) {
